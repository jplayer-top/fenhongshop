...
public class NumberPicker extends LinearLayout {
    ...
    public boolean inputEnable = false;
    ...
    public NumberPicker (Context context, AttributeSet attrs, int defStyle) {
        ...
        mInputText.setEnabled (inputEnable);//fixed by Plucky
        mInputText.setVisibility (inputEnable ? VISIBLE : INVISIBLE);
...
//				System.out.println("Set visible by showSoftInput");
                if (inputEnable) mInputText.setVisibility (View.VISIBLE);
            }
...
//			System.out.println("Set Invisible by changeValueByOne");
    ...
    private boolean updateInputTextView () {
        ...
        if (!TextUtils.isEmpty (text) && !text.equals (mInputText.getText ().toString ())) {
            mInputText.setText (text);//mark by Plucky
