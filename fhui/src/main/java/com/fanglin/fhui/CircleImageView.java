...
public class CircleImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		Log.d("CircleImageView onDraw:", String.valueOf(getWidth()));
	...
	private Bitmap getBitmapFromDrawable(Drawable drawable) {
		...
		try {
			...
			if (drawable instanceof ColorDrawable) {
				...
				// 更改一个BUG,当加载网络图片时，使用drawable.getIntrinsicWidth()会出现-1 的情况
				// 程序会崩溃,遂更改为mBitmapWidth Plucky
				bitmap = Bitmap.createBitmap(mBitmapWidth, mBitmapHeight,
						BITMAP_CONFIG);
			}
	...
	private void setup() {
		...
		try {
			...
			Log.d("CircleImageView setup:", String.valueOf(getWidth()));
